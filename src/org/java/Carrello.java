	...
	public static void main(String[] args) {
		...
		while (nuovoProdotto) {
			...
			if (risposta.equals("no")) {
				...
				if (!inputProdotto.equals("smartphone") && !inputProdotto.equals("televisore")
						&& !inputProdotto.equals("cuffie")) {
				...
				if (inputProdotto.equals("smartphone")) {
					...
					prodotti[prodotti_length] = new Smartphone(nome, descrizione, prezzoBase, IVA, tessera, codiceIMEI,
							memoria);
					prodotti_length++;
					...
					prodotti[prodotti_length] = new Televisore(nome, descrizione, prezzoBase, IVA, tessera, dimensioni,
							smartTV);
					prodotti_length++;
					...
					prodotti[prodotti_length] = new Cuffie(nome, descrizione, prezzoBase, IVA, tessera, colore,
							wireless);
					prodotti_length++;
				}
			}
